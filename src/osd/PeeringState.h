...
public:
 ...
 private:
  ...
  mini_flat_map<int, pg_shard_t> zone_primaries{0};
...
public:
  ...
  static mini_flat_map<int, pg_shard_t> calc_zone_primaries(
    const std::vector<int> &acting,
...
public:
  ...
  const mini_flat_map<int, pg_shard_t> &get_zone_primaries() const {
