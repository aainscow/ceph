...
CORO_TEST_F(neocls_version_fastec, test_version_inc_read, NeoRadosFastECTest)
{
  std::string_view oid = "obj";
  co_await create_obj(oid);
...
CORO_TEST_F(neocls_version_fastec, test_version_set, NeoRadosFastECTest)
{
  std::string_view oid = "obj";
  co_await create_obj(oid);
...
CORO_TEST_F(neocls_version_fastec, test_version_inc_cond, NeoRadosFastECTest)
{
  std::string_view oid = "obj";
  co_await create_obj(oid);
...
CORO_TEST_F(neocls_version_fastec, test_version_inc_check, NeoRadosFastECTest)
{
  std::string_view oid = "obj";
  co_await create_obj(oid);
