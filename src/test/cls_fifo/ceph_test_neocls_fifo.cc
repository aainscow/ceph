...
// FastEC versions of cls_fifo tests
CORO_TEST_F(cls_fifo_fastec, create, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(cls_fifo_fastec, get_info, NeoRadosFastECTest)
{
  auto& r = rados();
  std::string_view fifo_id = "fifo";
...
// FastEC versions of fifo tests
CORO_TEST_F(fifo_fastec, open_default, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, open_params, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, push_list_trim, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, push_too_big, NeoRadosFastECTest)
{
  static constexpr auto max_part_size = 2048ull;
  static constexpr auto max_entry_size = 128ull;
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, multiple_parts, NeoRadosFastECTest)
{
  static constexpr auto max_part_size = 2048ull;
  static constexpr auto max_entry_size = 128ull;
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, two_pushers, NeoRadosFastECTest)
{
  static constexpr auto max_part_size = 2048ull;
  static constexpr auto max_entry_size = 128ull;
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, two_pushers_trim, NeoRadosFastECTest)
{
  static constexpr auto max_part_size = 2048ull;
  static constexpr auto max_entry_size = 128ull;
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, push_batch, NeoRadosFastECTest)
{
  static constexpr auto max_part_size = 2048ull;
  static constexpr auto max_entry_size = 128ull;
  std::string_view fifo_id = "fifo";
...
CORO_TEST_F(fifo_fastec, trim_exclusive, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
  auto f = co_await FIFO::create(&dp, rados(), fifo_id, pool(),
				 asio::use_awaitable);
...
CORO_TEST_F(fifo_fastec, trim_all, NeoRadosFastECTest)
{
  std::string_view fifo_id = "fifo";
  auto f = co_await FIFO::create(&dp, rados(), fifo_id, pool(),
				 asio::use_awaitable);
