  ...
  if (prefix == "osd setcrushmap" ||
    ...
    if (pool_type == pg_pool_t::TYPE_ERASURE) {
      ...
      if (has_ec_params) {
        ...
        profile_name_stream << poolstr << "-ec-k" << ec_k << "-m" << ec_m << "-z" << ec_num_zones;
        ...
        if (osdmap.has_erasure_code_profile(auto_profile_name)) {
          ...
          auto it_z = existing_profile.find("num_zones");
          ...
          bool params_match = (it_k != existing_profile.end() && it_k->second == to_string(ec_k)) &&
                              ...
                              (it_z != existing_profile.end() && it_z->second == to_string(ec_num_zones));
          ...
          profile_map["num_zones"] = to_string(ec_num_zones);
