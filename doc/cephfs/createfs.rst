...
RADOS *OMAP* data structures are not supported by default in Erasure Coded pools. Therefore, if you wish to use Erasure Coded pools as CephFS metadata pools,
